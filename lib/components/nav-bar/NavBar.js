...
var _native = require('src/native');
    ...
    (0, _createClass3.default)(NavBarComponent, [{
                ...
                if (/^(#)/.test(v.icon) || v.antType) {
                    ...
                    if (v.sup) {
                        icon = _react2.default.createElement(
                            'span',
                            {
                                className: (0, _classnames2.default)('container-sup', { 'container-disable': v.disable }),
                                onClick: !v.disable && v.click
                            },
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                _navBar2.default,
                {
                    className: (0, _classnames2.default)('container', className),
                    iconName: null,
...
var NavBarContentLayout = exports.NavBarContentLayout = function NavBarContentLayout(props) {
    return _react2.default.createElement(
        'div',
        { className: 'ym-nav-bar-content-layout' },
        props.children
    );
};
